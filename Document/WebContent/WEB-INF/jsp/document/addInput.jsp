...
<body>
	...
	<s:fielderror />
	<form action="document_add.action" method="post"
		...
		<table class="ct" width="900" align="center" cellpadding="0" cellspacing="0">
			...
			<tr>
				<td colspan="2">
					<s:if test="#deps.size()<=0">没有可以发送的部门</s:if> 
					<s:else>
			...
			<tr>
				<td colspan="2"><input type="button" value="添加附件" id="addAttach" />
			...
			<tr>
				<td colspan="2"><textarea rows="30" cols="130" id="content" name="content"></textarea></td>
			</tr>
			<tr>
